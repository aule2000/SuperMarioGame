...
public class WinWindow implements Screen {
    ...
    public WinWindow(Game game)
    {
        ...
        Label gameOverLabel = new Label("Sveikiname. Jus laimejote!", font);
        Label playAgainLabel = new Label("Spauskite bet kur kad pradetumete is naujo", font);
